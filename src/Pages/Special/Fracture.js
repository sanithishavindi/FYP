  ...
  return (
    <Box sx={{ p: 4 }}>
      <Paper elevation={3} sx={{ p: 3, borderRadius: 4 }}>
        ...
        <List dense sx={{ mt: 4 }}>
          {['Emergency Stretchers', 'Cervical Collar', 'Patient Monitor', 'suturing kit', 'Stethoscope',  'Surgical Masks', 'Surgical Gloves sphygmomanometer (blood pressure)', 'oxygen cylinder with regulator and mask kit', 'suturing kit', 'crash cart(emergency drugs trolly)'].map((value) => {
