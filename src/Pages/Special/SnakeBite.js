  ...
  return (
    <Box sx={{ p: 4 }}>
      <Paper elevation={3} sx={{ p: 3, borderRadius: 4 }}>
        ...
        <List dense sx={{ mt: 4 }}>
          {['crash cart(emergency drugs trolly)', 'Emergency Stretchers', 'Stethoscope', 'sphygmomanometer (blood pressure)', 'ECG Machine', 'infusion pump', 'oxygen cylinder with regulator and mask kit', 'Surgical Masks', 'Surgical Gloves', 'syringe pump'].map((value) => {
