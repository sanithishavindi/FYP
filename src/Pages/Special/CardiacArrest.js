  ...
  return (
    <Box sx={{ p: 4 }}>
      <Paper elevation={3} sx={{ p: 3, borderRadius: 4 }}>
        ...
        <List dense sx={{ mt: 4 }}>
          {['Defibrillator', 'Stethoscope', 'Ventilators', 'ECG Machine', 'Cardiac Monitor', 'sphygmomanometer (blood pressure)', 'oxygen cylinder with regulator and mask kit', 'ambu bag with oxygen', 'intubation cannula', 'Laryngeal Mask Airways', 'crash cart(emergency drugs trolly)', 'Ultrasound machines',' Suction Machine', 'Central venous access device '].map((value) => {
