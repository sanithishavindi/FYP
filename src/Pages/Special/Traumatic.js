...
const Traumatic = () => {
  ...
  const resources = [
    { name: 'ECG Monitor', quantity: 2 },
    { name: 'Infusion Pump', quantity: 3 },
  ...
  const handleUpdate = () => {
    ...
    if (allMarked) {
      setUpdateMessage("All necessary resources are marked and updated.");
    } else {
      setUpdateMessage("Please mark all required resources before updating.");
    }
  };
