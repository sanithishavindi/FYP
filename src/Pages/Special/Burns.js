...
const Burns = () => {
  ...
  return (
    ...
    <Paper elevation={3} sx={{ p: 3, borderRadius: 4 }}>
      ...
      <List dense sx={{ mt: 4 }}>
        {['Suction Machine', 'Emergency Stretchers', 'Cervical Collar', 'crash cart(emergency drugs trolly)', 'Stethoscope', 'sphygmomanometer (blood pressure)', 'intubation cannula', 'ECG Machine', 'Central venous access device', 'patient monitor', 'blood warmer', 'infusion pump', 'oxygen cylinder with regulator and mask kit', 'laryngoscope', 'Surgical Masks', 'Surgical Gloves'].map((value) => {
